...
class IsaacROSRealSenseMonoRectLaunchFragment(IsaacROSLaunchFragment):
...
def generate_launch_description():
    realsense_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=(
            IsaacROSRealSenseMonoRectLaunchFragment.get_composable_nodes()
        ),
        output='screen'
    )

    return launch.LaunchDescription(
        [realsense_container] + IsaacROSRealSenseMonoRectLaunchFragment.get_launch_actions())
