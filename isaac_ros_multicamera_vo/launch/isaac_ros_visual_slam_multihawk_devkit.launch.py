...
MODULE_IDS = {
    # Nova Devkit Hawk ids
    'front_stereo_camera': 3,
    'left_stereo_camera': 5,
    'right_stereo_camera': 4
}
...
def generate_launch_description():
    ...
    nova_devkit_description = lu.include(
    ...
    return launch.LaunchDescription([nova_devkit_description,
